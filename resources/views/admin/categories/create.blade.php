    ...
    <form class="row g-3 needs-validation" action="{{ route('admin.categories.store')}}" method="post" novalidate enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            ...
            <div class="col-9">
                <input
                    type="text"
                    class="form-control col-9 @error('slug') is-invalid @enderror"
                    id="slug"
                    slug="slug"
                    value="{{ old('slug')}}"
                    data-sluger="slug"
                ...
                <div class="col-3">
                    <button class="btn btn-primary" data-sluger="button" data-sluger_url="{{ route('admin.categories.slug')}}" type="button">Generate</button>
                </div>
            </div>
